public class Person {
    ...
    public static void main(String[] args) {
        ...
        myName.setName(name("Khumairoh Silviani"));
        //Output name
        System.out.println(myName.getName());

        // Objek birthdate
        Person myBirthdate = new Person();
        myBirthdate.setBirthdate(birthdate("15 Mei 2002"));
        //output birthdate
